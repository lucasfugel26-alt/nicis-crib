...
export async function seedIfEmpty() {
  ...
  if (appSettings?.seededAt) {
    ...
    await put("settings", { id: "app", learnedCategories: {}, darkModeReady: true, demoDataRemovedAt: new Date().toISOString() });
    return;
  }

  if (appSettings) return;
  await put("settings", { id: "app", learnedCategories: {}, darkModeReady: true, createdAt: new Date().toISOString() });
}
