...
import { getCategories, money } from "../data/categories.js";
        ...
        <Card>
          ...
          <div className="space-y-4">
            {categoryRows.map((row) => (
              <div key={row.id}>
                <div className="mb-2 flex justify-between font-black"><CategoryPill id={row.id} settings={state.settings} /><span>{money(row.total)}</span></div>
