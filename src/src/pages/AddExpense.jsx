...
import { categories, categoryById, money, suggestCategory, todayISO } from "../data/categories.js";
    ...
    <div className="mx-auto max-w-2xl">
      <Card>
        ...
        <form onSubmit={submit} className="mt-6 space-y-4">
          <input autoFocus className="w-full rounded-[1.5rem] border-0 bg-cream px-5 py-5 text-lg font-bold outline-none ring-1 ring-cocoa/10 focus:ring-2 focus:ring-sage" placeholder="Produktname" value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} />
          ...
          <div className="flex items-center justify-between rounded-[1.5rem] bg-white/55 p-4">
            ...
            <p className="font-black">{money(form.price || 0)} · {categoryById[form.category]?.name}</p>
          </div>
